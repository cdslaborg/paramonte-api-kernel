...
module LogFunc_mod
    ...
    real(RK), parameter     :: LOG_SQRT_DET_INVCOVMAT = 0.581575404902840_RK ! log(sqrt(det(INVCOVMAT)))

    ! MVN_COEF

    real(RK), parameter     :: MVN_COEF = NDIM * LOG_INVERSE_SQRT_TWO_PI + LOG_SQRT_DET_INVCOVMAT
