...
\item[\mbox{\hyperlink{todo__todo000041}{Todo}}]The efficiency of this code can be further improved.\end{DoxyRefDesc}
...
\end{DoxyRemark}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000043}{Todo}}]The efficiency of this algorithm might still be improved by converting the upper triangle covariance matrix to a packed vector.\end{DoxyRefDesc}
