...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em Shifted\+Sample} & \+: The {\ttfamily contiguous} array of shape {\ttfamily (\+:,\+:)} containing the sample. \\
\hline
\mbox{\texttt{ in}}  & {\em Weight} & \+: The {\ttfamily contiguous} array of shape {\ttfamily (\+:,\+:)} containing the sample. \\
\hline
...
\item[\mbox{\hyperlink{todo__todo000067}{Todo}}]The efficiency of this code can be further improved.\end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000068}{Todo}}]The efficiency of this code can be further improved.\end{DoxyRefDesc}
...
\end{DoxyRemark}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000069}{Todo}}]The efficiency of this algorithm might still be improved by converting the upper triangle covariance matrix to a packed vector.\end{DoxyRefDesc}
...
\end{DoxyRemark}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000070}{Todo}}]The efficiency of this algorithm might still be improved by converting the upper triangle covariance matrix to a packed vector.\end{DoxyRefDesc}
