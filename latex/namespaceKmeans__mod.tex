...
\item[\mbox{\hyperlink{todo__todo000015}{Todo}}]All {\ttfamily minloc} queries in this procedure can be replaced with more efficient bin search algorithms.\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000016}{Todo}}]The variable {\ttfamily Cum\+Sum\+Dist\+Sq} does not have to be defined as {\ttfamily real64}.\end{DoxyRefDesc}
