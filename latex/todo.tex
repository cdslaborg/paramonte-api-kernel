...
\Hypertarget{todo__todo000037}%
 All {\ttfamily minloc} queries in this procedure can be replaced with more efficient bin search algorithms. 
\item[Subprogram \mbox{\hyperlink{namespaceMath__mod_a3974fffdcda7a33913960e0999a34b96}{Math\+\_\+mod\+::get\+Sum\+Exp\+\_\+\+RK}} (Log\+Value, max\+Log\+Value)]\label{todo__todo000039}%
...
\item[Type \mbox{\hyperlink{interfaceMathCumPropExp__mod_1_1genCumPropExp}{Math\+Cum\+Prop\+Exp\+\_\+mod\+::gen\+Cum\+Prop\+Exp}} ]\label{todo__todo000040}%
\Hypertarget{todo__todo000040}%
 This generic interface can be expanded to include input arrays with {\ttfamily Weight}s. 
\item[Type \mbox{\hyperlink{interfaceMathCumPropExp__mod_1_1getCumPropExp}{Math\+Cum\+Prop\+Exp\+\_\+mod\+::get\+Cum\+Prop\+Exp}} ]\label{todo__todo000041}%
\Hypertarget{todo__todo000041}%
 This generic interface can be expanded to include input arrays with {\ttfamily Weight}s. 
\item[Type \mbox{\hyperlink{interfaceMathCumSum__mod_1_1genCumSum}{Math\+Cum\+Sum\+\_\+mod\+::gen\+Cum\+Sum}} ]\label{todo__todo000042}%
\Hypertarget{todo__todo000042}%
 This generic interface can be expanded to include input arrays with {\ttfamily Weight}s. 
\item[Type \mbox{\hyperlink{interfaceMathCumSum__mod_1_1getCumSum}{Math\+Cum\+Sum\+\_\+mod\+::get\+Cum\+Sum}} ]\label{todo__todo000043}%
\Hypertarget{todo__todo000043}%
 This generic interface can be expanded to include input arrays with {\ttfamily Weight}s. 
\item[Type \mbox{\hyperlink{interfaceMathLogSpace__mod_1_1genLogSpace}{Math\+Log\+Space\+\_\+mod\+::gen\+Log\+Space}} ]\label{todo__todo000044}%
...
\item[Type \mbox{\hyperlink{interfaceMathLogSpace__mod_1_1getLogSpace}{Math\+Log\+Space\+\_\+mod\+::get\+Log\+Space}} ]\label{todo__todo000045}%
\Hypertarget{todo__todo000045}%
 This generic interface can be expanded to include procedures with real-\/valued input argument {\ttfamily space} instead of {\ttfamily count}. 
\item[Subprogram \mbox{\hyperlink{namespaceMathLogSub__mod_a797374f2eb6de823ca646acc993714e1}{Math\+Log\+Sub\+\_\+mod\+::gen\+Log\+Sum\+Exp\+\_\+\+CK}} (Log\+Value, max\+Log\+Value)]\label{todo__todo000047}%
...
\item[Subprogram \mbox{\hyperlink{namespaceMathLogSub__mod_a145e2eace40604d720ac8bda5f5bac80}{Math\+Log\+Sub\+\_\+mod\+::gen\+Log\+Sum\+Exp\+\_\+\+RK}} (Log\+Value, max\+Log\+Value)]\label{todo__todo000046}%
\Hypertarget{todo__todo000046}%
 This function should be modified to rely on {\ttfamily \mbox{\hyperlink{namespaceMathLogSub__mod_ac1b3e61434784f7ffbc3f10e80890254}{get\+Sum\+Exp\+\_\+\+RK()}}}.  
\item[Subprogram \mbox{\hyperlink{namespaceMathLogSub__mod_ac1b3e61434784f7ffbc3f10e80890254}{Math\+Log\+Sub\+\_\+mod\+::get\+Sum\+Exp\+\_\+\+RK}} (Log\+Value, max\+Log\+Value)]\label{todo__todo000048}%
...
\item[Type \mbox{\hyperlink{interfaceMathLogSumExp__mod_1_1genLogSumExp}{Math\+Log\+Sum\+Exp\+\_\+mod\+::gen\+Log\+Sum\+Exp}} ]\label{todo__todo000049}%
\Hypertarget{todo__todo000049}%
 This generic interface can be expanded to include input arrays with {\ttfamily Weight}s. 
\item[Type \mbox{\hyperlink{interfaceMathMinMax__mod_1_1genMinMax}{Math\+Min\+Max\+\_\+mod\+::gen\+Min\+Max}} ]\label{todo__todo000050}%
...
\end{DoxyEnumerate}
\item[Type \mbox{\hyperlink{interfaceMathMinMax__mod_1_1getMinMax}{Math\+Min\+Max\+\_\+mod\+::get\+Min\+Max}} ]\label{todo__todo000051}%
...
\end{DoxyEnumerate}
\item[Type \mbox{\hyperlink{interfaceMatrixComparison__mod_1_1isEqualLow}{Matrix\+Comparison\+\_\+mod\+::is\+Equal\+Low}} ]\label{todo__todo000052}%
\Hypertarget{todo__todo000052}%
 The functionality of this interface can be expanded to cover complex numbers. 
\item[Type \mbox{\hyperlink{interfaceMatrixComparison__mod_1_1isEqualLowDia}{Matrix\+Comparison\+\_\+mod\+::is\+Equal\+Low\+Dia}} ]\label{todo__todo000053}%
\Hypertarget{todo__todo000053}%
 The functionality of this interface can be expanded to cover complex numbers. 
\item[Type \mbox{\hyperlink{interfaceMatrixComparison__mod_1_1isEqualUpp}{Matrix\+Comparison\+\_\+mod\+::is\+Equal\+Upp}} ]\label{todo__todo000054}%
\Hypertarget{todo__todo000054}%
 The functionality of this interface can be expanded to cover complex numbers. 
\item[Type \mbox{\hyperlink{interfaceMatrixComparison__mod_1_1isEqualUppDia}{Matrix\+Comparison\+\_\+mod\+::is\+Equal\+Upp\+Dia}} ]\label{todo__todo000055}%
\Hypertarget{todo__todo000055}%
 The functionality of this interface can be expanded to cover complex numbers. 
\item[Type \mbox{\hyperlink{interfaceMatrixDiag__mod_1_1genDiag}{Matrix\+Diag\+\_\+mod\+::gen\+Diag}} ]\label{todo__todo000057}%
...
\item[Type \mbox{\hyperlink{interfaceMatrixDiag__mod_1_1genDiagMat}{Matrix\+Diag\+\_\+mod\+::gen\+Diag\+Mat}} ]\label{todo__todo000056}%
\Hypertarget{todo__todo000056}%
 The functionality of this interface can be expanded to make the input argument {\ttfamily ncol} optional by adding further possible interfaces. 
\item[Type \mbox{\hyperlink{interfaceMatrixDiag__mod_1_1genEye}{Matrix\+Diag\+\_\+mod\+::gen\+Eye}} ]\label{todo__todo000058}%
...
\item[Subprogram \mbox{\hyperlink{namespaceSample__mod_a81524ddc27a48db65744d80cfad9b348}{Sample\+\_\+mod\+::merge\+Mean\+Cov\+Upp\+Dense}} (nd, npA, MeanA, Cov\+UppA, npB, MeanB, Cov\+UppB)]\label{todo__todo000070}%
\Hypertarget{todo__todo000070}%
 The efficiency of this algorithm might still be improved by converting the upper triangle covariance matrix to a packed vector. 
\item[Type \mbox{\hyperlink{interfaceSampleECDF__mod_1_1getECDF}{Sample\+ECDF\+\_\+mod\+::get\+ECDF}} ]\label{todo__todo000071}%
\Hypertarget{todo__todo000071}%
 This generic interface could be extended to input {\ttfamily Sample}s of higher ranks. 
\item[Type \mbox{\hyperlink{interfaceSampleFlat__mod_1_1genFlat}{Sample\+Flat\+\_\+mod\+::gen\+Flat}} ]\label{todo__todo000072}%
\Hypertarget{todo__todo000072}%
 This generic interface can be expanded to include procedures with real-\/valued input argument {\ttfamily space} instead of {\ttfamily count}. 
\item[Type \mbox{\hyperlink{interfaceSampleMean__mod_1_1genMean}{Sample\+Mean\+\_\+mod\+::gen\+Mean}} ]\label{todo__todo000073}%
...
\item[Type \mbox{\hyperlink{interfaceSampleShift__mod_1_1genShifted}{Sample\+Shift\+\_\+mod\+::gen\+Shifted}} ]\label{todo__todo000074}%
...
\item[Type \mbox{\hyperlink{interfaceSampleShift__mod_1_1getShifted}{Sample\+Shift\+\_\+mod\+::get\+Shifted}} ]\label{todo__todo000075}%
...
\item[Type \mbox{\hyperlink{interfaceSampleVariance__mod_1_1genVariance}{Sample\+Variance\+\_\+mod\+::gen\+Variance}} ]\label{todo__todo000076}%
...
\item[Subprogram \mbox{\hyperlink{namespaceStatistics__mod_a1fd519cf4d71eb72a8b096f60398b46f}{Statistics\+\_\+mod\+::get\+Beta\+CDF\+\_\+\+RK32}} (alpha, beta, x)]\label{todo__todo000078}%
\Hypertarget{todo__todo000078}%
 The efficiency of this code can be improved by making {\ttfamily x} a vector on input. 
\item[Subprogram \mbox{\hyperlink{namespaceStatistics__mod_a6f2bac87eb4e963f359c89840f4702a3}{Statistics\+\_\+mod\+::get\+Beta\+CDF\+\_\+\+RK64}} (alpha, beta, x)]\label{todo__todo000079}%
\Hypertarget{todo__todo000079}%
 The efficiency of this code can be improved by making {\ttfamily x} a vector on input. 
\item[(=) Type \mbox{\hyperlink{interfaceString__mod_1_1assignment_07_0a_08}{String\+\_\+mod\+::assignment(=)}} ]\label{todo__todo000081}%
\Hypertarget{todo__todo000081}%
 This assignment interface can be extended to support arrays of higher ranks (dimensions). 
\item[Type \mbox{\hyperlink{interfaceString__mod_1_1val2str}{String\+\_\+mod\+::val2str}} ]\label{todo__todo000080}%
